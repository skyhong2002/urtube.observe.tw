...
urtube 是正在開發中的 **data-driven 交友網站**，以使用者授權的行為資料為基礎，協助人們找到長期具有共同興趣與喜好的朋友。目前從 YouTube 觀看紀錄出發，分析持續關注的主題、創作者與偏好變化，將這些線索轉化為同好探索與交流的起點。
...
urtube 希望以行為資料提升同好探索的準確度，找出長期具有共同興趣與喜好的族群，讓使用者更容易遇見有共同話題、值得持續認識的人。這是應用程式與網站的核心方向：從實際行為理解偏好，從共同偏好建立連結，再透過交流發展友誼。

目前以 YouTube 觀看紀錄作為行為資料來源，提供跨時間的興趣洞察，並以最近 90 天的共通主題與頻道資料進行配對。私人興趣地圖協助使用者理解配對依據、確認自己的偏好，也在等待合適朋友時提供可用的回饋；長期興趣的穩定性將作為後續配對方法的發展重點。

**重要影響力（Great Impact）**在於讓日常累積的興趣成為建立友誼的連結，減少尋找共同話題與合適朋友的摸索成本，支持以共同喜好為基礎、能持續交流的人際關係。後續影響力評估將追蹤使用者對推薦共同興趣的認同程度、好友邀請接受率，以及經使用者同意回報的持續交流情形，逐步驗證配對品質與長期連結的價值。

...
const dashboardStyles = `
  .yt-profile{align-items:center;display:flex;gap:18px;margin-bottom:26px}
  .yt-avatar{align-items:center;background:linear-gradient(135deg,#d03b3b,#b02f2f);border-radius:50%;box-shadow:var(--shadow);color:#fff;display:flex;flex:0 0 76px;font-size:32px;font-weight:800;height:76px;justify-content:center;width:76px}
  .yt-profile-copy h1{font-size:clamp(28px,4vw,42px);letter-spacing:-.03em;line-height:1.05;margin:2px 0 4px}
  .yt-profile-copy .eyebrow{margin:0}.yt-profile-meta{color:var(--quiet);font-size:12px}
  .yt-range{display:flex;gap:6px;margin-bottom:22px;overflow-x:auto;padding:2px 0}
  .yt-range a{background:var(--surface);border:1px solid var(--line);border-radius:999px;color:var(--muted);font-size:12px;font-weight:600;padding:7px 14px;text-decoration:none;white-space:nowrap}.yt-range a:hover{border-color:var(--line-strong);color:var(--text)}.yt-range a[aria-current=page]{background:var(--accent);border-color:var(--accent);color:#fff}
  .yt-import-control{align-items:center;display:flex;gap:12px;margin:-8px 0 22px}.yt-import-control[hidden]{display:none}.yt-import-control button{background:var(--surface);border:1px solid var(--line-strong);border-radius:999px;color:var(--text);cursor:pointer;font:inherit;font-size:12px;font-weight:600;padding:7px 14px}.yt-import-control button:hover{border-color:var(--quiet)}.yt-import-control button:disabled{cursor:wait;opacity:.65}.yt-import-control span{color:var(--quiet);font-size:11px}
  .yt-stats{display:grid;gap:12px;grid-template-columns:repeat(auto-fit,minmax(150px,1fr));margin-bottom:34px}
  .yt-stat{background:var(--surface);border:1px solid var(--line);border-radius:14px;box-shadow:var(--shadow);padding:16px 18px}.yt-stat strong{display:block;font-size:26px;letter-spacing:-.02em}.yt-stat span{color:var(--quiet);font-size:10px;font-weight:700;letter-spacing:.06em;text-transform:uppercase}
  .yt-section{background:var(--surface);border:1px solid var(--line);border-radius:16px;box-shadow:var(--shadow);margin-top:22px;padding:22px 24px}
  .yt-heading{align-items:end;display:flex;justify-content:space-between;margin-bottom:16px}.yt-heading h2{font-size:17px;letter-spacing:-.01em;margin:0}.yt-heading span{color:var(--quiet);font-size:11px}
  .yt-bars{align-items:end;border-bottom:1px solid var(--line);display:flex;gap:3px;height:150px;overflow-x:auto;padding:0 0 1px}.yt-day{background:var(--accent);border-radius:3px 3px 0 0;display:block;flex:1 0 7px;min-height:2px}.yt-day:hover{background:var(--accent-deep)}
  .yt-columns{background:transparent;border:0;box-shadow:none;display:grid;gap:22px;grid-template-columns:minmax(0,1.25fr) minmax(280px,.75fr);padding:0}
  .yt-columns>section{background:var(--surface);border:1px solid var(--line);border-radius:16px;box-shadow:var(--shadow);padding:22px 24px}
  .yt-table{border-collapse:collapse;width:100%}.yt-table td,.yt-table th{border-bottom:1px solid var(--line);font-size:13px;padding:9px 8px;text-align:right}.yt-table td{font-variant-numeric:tabular-nums}.yt-table th{color:var(--quiet);font-size:10px;font-weight:700;letter-spacing:.05em;text-transform:uppercase}.yt-table td:first-child,.yt-table th:first-child{text-align:left}.yt-table tbody tr:hover{background:var(--surface-raised)}.yt-table a{color:var(--text);text-decoration:none}.yt-table a:hover{color:var(--accent-deep)}
  .yt-channel{align-items:center;display:flex;gap:10px;min-width:0}.yt-channel img,.yt-channel-avatar{background:var(--surface-raised);border-radius:50%;display:grid;flex:0 0 32px;height:32px;object-fit:cover;place-items:center;width:32px}.yt-channel-avatar{color:var(--muted);font-size:12px;font-weight:700}
  .yt-sort a{color:var(--muted)}.yt-sort a[aria-current=page]{color:var(--accent-deep);font-weight:700;text-decoration:underline;text-underline-offset:3px}
  .yt-distribution{display:grid;gap:10px}.yt-distribution-row{align-items:center;display:grid;gap:10px;grid-template-columns:72px minmax(0,1fr) 40px}.yt-distribution-row span{color:var(--muted);font-size:12px}.yt-distribution-row span:last-child{font-variant-numeric:tabular-nums;text-align:right}.yt-distribution-track{background:var(--surface-raised);border-radius:999px;height:8px}.yt-distribution-track i{background:var(--blue);border-radius:999px;display:block;height:100%;min-width:2px}
  .yt-chase-controls{align-items:center;display:grid;gap:12px;grid-template-columns:36px 90px minmax(0,1fr);margin-bottom:18px}.yt-chase-controls button{align-items:center;background:var(--surface-raised);border:1px solid var(--line-strong);border-radius:50%;color:var(--text);cursor:pointer;display:flex;font-size:12px;height:34px;justify-content:center;padding:0;width:34px}.yt-chase-controls input{accent-color:var(--accent);width:100%}.yt-chase-period{font-size:12px;font-variant-numeric:tabular-nums;white-space:nowrap}
  .yt-chase-rows{display:grid;gap:9px;min-height:280px}.yt-chase-row{align-items:center;display:grid;gap:10px;grid-template-columns:32px minmax(0,1fr) 62px}.yt-chase-row img,.yt-chase-row .yt-channel-avatar{height:32px;width:32px}.yt-chase-copy{min-width:0}.yt-chase-label{display:flex;font-size:12px;justify-content:space-between;margin-bottom:3px}.yt-chase-label strong{overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.yt-chase-track{background:var(--surface-raised);border-radius:999px;height:8px;overflow:hidden}.yt-chase-track i{background:var(--accent);border-radius:999px;display:block;height:100%;transition:width .4s ease;width:var(--share)}.yt-chase-value{color:var(--muted);font-size:11px;font-variant-numeric:tabular-nums;text-align:right}
  .yt-taxonomy{background:transparent;border:0;box-shadow:none;display:grid;gap:22px;grid-template-columns:minmax(0,.85fr) minmax(0,1.15fr);padding:0}
  .yt-taxonomy>div{background:var(--surface);border:1px solid var(--line);border-radius:16px;box-shadow:var(--shadow);padding:22px 24px}
  .yt-topic-list{display:flex;flex-wrap:wrap;gap:8px}.yt-topic{background:var(--surface-raised);border:1px solid var(--line);border-radius:10px;padding:9px 12px}.yt-topic strong{display:block;font-size:12px}.yt-topic span{color:var(--quiet);font-size:10px}
  .yt-keywords{align-content:center;align-items:center;display:flex;flex-wrap:wrap;gap:8px 14px;justify-content:center;min-height:190px;padding:8px}.yt-keywords a{color:var(--cloud-color);font-size:var(--cloud-size);font-weight:650;line-height:1;text-decoration:none}.yt-keywords a:hover{color:var(--accent-deep);text-decoration:underline;text-underline-offset:4px}
  .yt-recent{display:grid;gap:20px 16px;grid-template-columns:repeat(auto-fit,minmax(190px,1fr))}.yt-video{color:inherit;display:block;min-width:0;text-decoration:none}.yt-video-media{aspect-ratio:16/9;background:var(--surface-raised);border-radius:10px;box-shadow:var(--shadow);display:block;overflow:hidden;width:100%}.yt-video img,.yt-video-placeholder{height:100%;object-fit:cover;transition:transform .2s ease;width:100%}.yt-video:hover img{transform:scale(1.03)}.yt-video h3{font-size:13px;line-height:1.35;margin:9px 0 4px}.yt-video:hover h3{color:var(--accent-deep)}.yt-video p{color:var(--quiet);font-size:11px;line-height:1.4;margin:0}
  @media(max-width:760px){.yt-columns,.yt-taxonomy{grid-template-columns:1fr}.yt-recent{grid-template-columns:repeat(2,minmax(0,1fr))}.yt-table td,.yt-table th{padding-inline:4px}.yt-section,.yt-columns>section,.yt-taxonomy>div{padding:16px}}
  @media(max-width:420px){.yt-recent{gap:16px 10px}.yt-video h3{font-size:12px}.yt-chase-row{grid-template-columns:28px minmax(0,1fr) 52px}.yt-chase-row img,.yt-chase-row .yt-channel-avatar{height:28px;width:28px}.yt-keywords{gap:8px 10px;padding-inline:0}.yt-profile{gap:14px}.yt-avatar{flex-basis:60px;font-size:26px;height:60px;width:60px}}
`;
...
export function youtubeDashboardPage(
  ...
  const taxonomy = `<section class="yt-section"><div class="yt-taxonomy"><div><div class="yt-heading"><h2>Stable topics</h2><span>AI-classified</span></div>
    ...
    <div class="yt-keywords">${data.keywords.map((keyword, index) => {
      ...
      const colors = ['#0b0b0b', '#52514e', '#b02f2f', '#52514e'];
  ...
  const intro = `<style>${dashboardStyles}</style><section class="yt-profile">
    ...
    <div class="yt-profile-meta">${rangeLabel(data.range)} · ${Math.round(data.stats.metadataCoverage * 100)}% metadata coverage · <a href="/">home</a></div></div></section>`;
  return shell(`${ownerName} · YouTube`, intro + rangeNav + importControl + stats + (options.setupHtml ?? '') + bars

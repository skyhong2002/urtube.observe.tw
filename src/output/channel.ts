...
const styles = `
  .site-main{max-width:1480px;padding-top:14px}
  .ch-page .section{background:none;border:0;border-radius:0;box-shadow:none;margin-top:24px;padding:0}
  .ch-page .section-head{align-items:baseline;gap:6px 14px;justify-content:flex-start;margin-bottom:10px;min-height:28px;padding-right:84px}.ch-page .section-head h2{font-size:19px;letter-spacing:-.025em}.ch-page .section-head span{font-size:12px}
  ...
  .ch-shelf{position:relative}.ch-controls{display:flex;gap:6px;position:absolute;right:0;top:-40px}.ch-controls button{background:var(--raised);border:0;border-radius:50%;color:var(--ink);cursor:pointer;font-size:17px;height:30px;width:30px}.ch-controls button:disabled{cursor:default;opacity:.3}
  ...
  .ch-nums{display:flex;flex-wrap:wrap;gap:2px 8px;align-items:baseline;margin-top:auto}.ch-nums strong{font-size:12px;font-variant-numeric:tabular-nums;font-weight:650}.ch-nums span{color:var(--muted);font-size:11px;font-variant-numeric:tabular-nums}.ch-person .ch-main>div{text-align:center}.ch-person .ch-nums{justify-content:center}.ch-person .ch-main small{font-size:10px}

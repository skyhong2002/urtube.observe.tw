...
export interface ActionableMatchingCandidateCard extends MatchingCandidateCard {
  ...
  topicMatch?: { score: number | null; provisional: boolean; reasons: string[]; detailsVisible: boolean; details?: Array<{genre: Genre; score: number | null; keywords?: string[]}>; available?: Genre[]; selected?: Genre[]; unavailable?: 'pending' | 'consent' | 'service' };
}
...
const matchesStyles = `
  ...
  .mt-blend-category{padding:10px 0}.mt-blend-category+.mt-blend-category{border-top:1px solid var(--line)}.mt-blend-keywords{display:flex;flex-wrap:wrap;gap:6px 14px;margin-top:10px;color:var(--muted);font-size:12px;line-height:1.6;overflow-wrap:anywhere}.mt-blend-keywords span{max-width:100%}
  @media(max-width:620px){.mt-blend-keywords{gap:6px 12px}.mt-vs{grid-template-columns:minmax(0,1fr) 66px minmax(0,1fr)}.mt-vs-score{border-width:4px;height:62px;width:62px}.mt-vs-score strong{font-size:16px}.mt-vs-score span{font-size:7px}.mt-side{min-height:300px;padding:20px 8px}.mt-side h2{overflow-wrap:anywhere}.mt-side .mt-pill{font-size:9px;padding:3px 6px}}
`;

...
[data-processing-live] [data-v3-static]{display:none}.yt-pipeline-stage{border-top:1px solid var(--line);padding:8px 0;min-width:0}.yt-pipeline-stage h3{font-size:14px;margin:0}.yt-pipeline-stage p{font-size:12px}.yt-pipeline-stage progress{height:5px;margin:5px 0}.yt-pipeline-heading{display:flex;align-items:baseline;justify-content:space-between;gap:8px}.yt-pipeline-stage span{font-size:12px;color:var(--muted)}.yt-pipeline-eta{float:right}.yt-pipeline-heading h3{font-size:13px}.yt-processing-monitor [data-monitor-content]{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));column-gap:24px}.yt-monitor-details{grid-column:1/-1}.yt-monitor-details h3{font-size:13px}.yt-monitor-controls{margin-top:4px}.yt-processing-monitor details{margin-top:8px}@media(max-width:600px){.yt-processing-monitor [data-monitor-content]{grid-template-columns:minmax(0,1fr)}}

...
.yt-popular-shelf .ch-rows{display:flex;gap:12px;overflow-x:auto;overscroll-behavior-x:contain;scroll-snap-type:x proximity;scrollbar-width:thin;padding:4px 0 12px}
.yt-popular-shelf .yt-channel-row,.yt-popular-shelf .yt-top-video{display:flex;flex-direction:column;align-items:stretch;position:relative;flex:0 0 140px;min-width:0;padding:0;gap:8px;scroll-snap-align:start;border-radius:6px}
...
.yt-popular-shelf.is-grid .ch-rows{display:grid;grid-template-columns:repeat(auto-fill,minmax(130px,1fr));overflow:visible;row-gap:16px;scroll-snap-type:none}
@media(min-width:1000px){.yt-popular-shelf .yt-channel-row,.yt-popular-shelf .yt-top-video{flex-basis:calc((100% - 72px)/7)}.yt-popular-shelf.is-grid .ch-rows{grid-template-columns:repeat(7,minmax(0,1fr))}}
@media(max-width:560px){.yt-popular-shelf .ch-rows{gap:12px}.yt-popular-shelf .yt-channel-row,.yt-popular-shelf .yt-top-video{flex-basis:132px}.yt-popular-shelf.is-grid .ch-rows{grid-template-columns:repeat(2,minmax(0,1fr))}.yt-shelf-controls button{width:40px;height:40px}}
`;
